...
public class CertificateSigningRequestList implements KubernetesResource, KubernetesResourceList<CertificateSigningRequest> {
    ...
    @JsonProperty("items")
    private List<com.kubernetes.api.model.certificates.v1.CertificateSigningRequest> items = new ArrayList<com.kubernetes.api.model.certificates.v1.CertificateSigningRequest>();
    /**
     *
     * (Required)
     *
     ...
     * @param items
     */
    public CertificateSigningRequestList(String apiVersion, List<com.kubernetes.api.model.certificates.v1.CertificateSigningRequest> items, String kind, ListMeta metadata) {
        super();
    ...
    @JsonProperty("items")
    public List<com.kubernetes.api.model.certificates.v1.CertificateSigningRequest> getItems() {
        return items;
    }

    @JsonProperty("items")
    public void setItems(List<com.kubernetes.api.model.certificates.v1.CertificateSigningRequest> items) {
        this.items = items;
    }
