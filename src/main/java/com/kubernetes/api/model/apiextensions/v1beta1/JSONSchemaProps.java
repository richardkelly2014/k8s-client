...
public class JSONSchemaProps implements KubernetesResource {
    ...
    private Map<String, com.kubernetes.api.model.apiextensions.v1beta1.JSONSchemaProps> definitions;
    ...
    private Map<String, com.kubernetes.api.model.apiextensions.v1beta1.JSONSchemaProps> patternProperties;
    @JsonProperty("properties")
    private Map<String, com.kubernetes.api.model.apiextensions.v1beta1.JSONSchemaProps> properties;
    ...
    @JsonProperty("definitions")
    public Map<String, com.kubernetes.api.model.apiextensions.v1beta1.JSONSchemaProps> getDefinitions() {
        return definitions;
    }

    @JsonProperty("definitions")
    public void setDefinitions(Map<String, com.kubernetes.api.model.apiextensions.v1beta1.JSONSchemaProps> definitions) {
        this.definitions = definitions;
    }
    ...
    @JsonProperty("patternProperties")
    public Map<String, com.kubernetes.api.model.apiextensions.v1beta1.JSONSchemaProps> getPatternProperties() {
        return patternProperties;
    }

    @JsonProperty("patternProperties")
    public void setPatternProperties(Map<String, com.kubernetes.api.model.apiextensions.v1beta1.JSONSchemaProps> patternProperties) {
        this.patternProperties = patternProperties;
    }

    @JsonProperty("properties")
    public Map<String, com.kubernetes.api.model.apiextensions.v1beta1.JSONSchemaProps> getProperties() {
        return properties;
    }

    @JsonProperty("properties")
    public void setProperties(Map<String, com.kubernetes.api.model.apiextensions.v1beta1.JSONSchemaProps> properties) {
        this.properties = properties;
    }
