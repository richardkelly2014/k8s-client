...
public class OpenIDConnectionUtils {
    ...
    /**
     * Fetch OpenID Connect token from Kubeconfig, check whether it's still valid or not; If expired
     * handle token refresh with OpenID Connection provider APIs
     *
     ...
     * @param shouldPersistUpdatedTokenInKubeConfig boolean value whether to modify kubeconfig file
     *                                              in disc or not
     ...
     * @param clientSecret                          client secret
     * @param shouldPersistUpdatedTokenInKubeConfig boolean value whether to update local kubeconfig
     *                                              file or not
    ...
    /**
     * OpenID providers publish their metadata at a well-known URL OpenID providers publish their
     * metadata at a well-known URL which looks like this: https://[base-server-url]/.well-known/openid-configuration
    ...
    /**
     * Well known URL for getting OpenID Connect metadata. https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderConfig
     *
    ...
    static boolean persistKubeConfigWithUpdatedToken(String kubeConfigPath, Map<String, Object> updatedAuthProviderConfig) throws IOException {
        com.kubernetes.api.model.Config config = KubeConfigUtils.parseConfig(new File(kubeConfigPath));
    ...
    private static boolean persistKubeConfigWithUpdatedToken(Map<String, Object> updatedAuthProviderConfig) throws IOException {
        return persistKubeConfigWithUpdatedToken(com.kubernetes.client.Config.getKubeconfigFilename(), updatedAuthProviderConfig);
    }
}
